        ...
        return (
          <div key={step.num} className="flex items-center gap-1 sm:gap-2">
            <button
              ...
              className={`flex items-center justify-center gap-1.5 px-2 sm:px-4 py-1.5 rounded-full transition-all duration-300 w-[100px] sm:w-[130px] ${isActive
            ...
            >
              <div className={`shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold transition-colors ${isActive
              ...
              <span className={`font-bold text-xs sm:text-sm whitespace-nowrap transition-colors ${isActive
                  ? 'text-[#ff3a70]'
                  : isPast
